...
public class CameraControlOptions {
	...
	/**
	 * Set the sharpness of the image. Sharpness value between -100 and 100. Default
	 * is 0.
	 * 
	 * @param sharpness
	 *            the new sharpness value, in the -100..100 interval.
	 */
	...
	/**
	 * Set the contrast of the image. Contrast value between -100 and 100. Default
	 * is 0.
	 * 
	 * @param contrast
	 *            the new contrast value, in the -100..100 interval.
	 */
	...
	/**
	 * Set the brightness of the image. 0 is black, 100 is white. Default is 50.
	 * 
	 * @param brightness
	 *            the new brightness value, in the 0..100 interval.
	 */
	...
	/**
	 * Set the colour saturation of the image. Saturation value between -100 and
	 * 100. 0 is the default.
	 * 
	 * @param saturation
	 *            the new saturation value, in the -100..100 interval.
	 */
	 ...
	 * 
	 * @param iso
	 *            the new ISO value, in the 100..800 interval.
	 */
	...
	/**
	 * Set the EV compensation of the image. Range is -10 to +10. Default is 10.
	 * 
	 * @param evCompensation
	 *            the new EV compensation value, in the -10..10 interval.
	 */
	 ...
	 * 
	 * @param awbMode
	 *            the new automatic white balance mode.
	 */
	 ...
	 * 
	 * @param imageEffect
	 *            the new effected to be applied to the image.
	 */
	 ...
	 * 180 and 270 degree rotations are supported (cfr RotationDegree).
	 * 
	 * @param rotationDegree
	 *            the new rotation to be applied to the image.
	 */
	 ...
	 * 
	 * @param active
	 *            true to flip the image horizontally. False otherwise.
	 */
	 ...
	 * 
	 * @param cameraMode
	 *            the new camera mode to be applied on the image.
	 */
	 ...
	 *            true to add time on the picture. False otherwise.
	 * @param annotationDate
	 *            true to add date on the picture. False otherwise.
	 * @param annotationTxt
	 *            the text to add on the picture. null if unused
	 */
	...
	/**
	 * Get the options to add to command line requests, regarding camera control
	 * options.
	 * 
